# -*- coding: utf-8 -*-
"""
Created on Sun Aug  7 16:48:37 2022
...
#this is a function with varfiable
def aboutMe(name):
    print('this is ' + name)
...
def keywordFlag(keyword):
    ...
    for x in range(0,length):
        ...
        keyword_flag.append(flag)
    return keyword_flag
kewordflag = keywordFlag('murder')

#creating a new column in dataframe

data['keyword_flag'] = pd.Series(kewordflag)

#data =data.drop('keyword_flag',axis = 1)
